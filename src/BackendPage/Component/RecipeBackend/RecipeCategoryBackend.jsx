...
function RecipeCategoryBackend({ onSelectCategory }) {
                ...
                {categories.map((category) => (
                    <li key={category.id} className="py-3 flex justify-between items-center">
                        <div
                            ...
                            className="mr-3 cursor-pointer transition duration-300 ease-in-out hover:bg-gray-100"
                    ...
                    <div className="absolute top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-4 rounded shadow-md" style={{ zIndex: 1000 }}>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows="5"
                                className="border border-gray-300 rounded p-2 mb-2 text-center"  // Added text-center class
                            />
                        </div>
                        ...
                        <button
                            ...
                            className={`mt-3 px-4 ml-3 py-2 rounded ${newCategoryName.length <= 0 || newCategoryNameEN.length <= 0 ? 'bg-gray-300 cursor-not-allowed' : 'bg-blue-500 hover:bg-blue-600'} text-white`}
                            disabled={newCategoryName.length <= 0 || newCategoryNameEN.length <= 0}
                        >
                            Save
                        </button>
                    </div>
            ...
            {/* {showEditPopup && (
                <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center" style={{ zIndex: 999 }}>
                    ...
                    <div className="absolute top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-4 rounded shadow-md" style={{ zIndex: 1000 }}>
                        ...
                        <div className="mb-2">
                            <label htmlFor="newCategoryName" className="block text-sm font-medium text-gray-600">Category Name:</label>
                            <input
                                type="text"
                                id="newCategoryName"
                                value={newCategoryName}
                        ...
                        <div className="mb-2 mt-3">
                            <label htmlFor="newCategoryNameEN" className="block text-sm font-medium text-gray-600">Category Name (English):</label>
                            <input
                                type="text"
                        ...
                        <button
                            ...
                            className={`px-4 ml-3 py-2 rounded ${newCategoryName.length <= 0 ? 'bg-gray-300 cursor-not-allowed' : 'bg-blue-500 hover:bg-blue-600'} text-white`}
...
export default RecipeCategoryBackend;
